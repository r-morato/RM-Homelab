...
NFS. The open mitigation is a copy of the backup archives that doesn't live on this box —
see the gap noted in [storage](../docs/storage.md) and [backups](../docs/backups.md).
