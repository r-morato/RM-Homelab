...
A small battery-friendly wall display on the rack that shows cluster stats at a glance —
node load, memory, guest count, backup age — without opening a browser.
