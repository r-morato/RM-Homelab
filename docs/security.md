...
port-forwarded; remote access is via VPN back home. Within that context, the design choices below. 
Hardening is an ongoing effort — the roadmap at the end lists what's still in progress.
